...
import { RiHeart3Fill, RiHeart3Line, RiUser3Line, RiCalendarLine, RiArrowLeftLine, RiShoppingBag3Line } from '@remixicon/react'
...
const SingleDesign = () => {
    ...
    return (
      <div className="min-h-screen  flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-2">Design Not Found</h2>
          <button 
  ...
  return (
    <div className="min-h-screen mt-50 bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 py-8 px-4">
      <div className="max-w-7xl mx-auto" ref={containerRef}>
        {/* Back Button */}
        <button
          onClick={() => navigate('/designs')}
          className="mb-6 flex items-center gap-2 text-purple-600 hover:text-purple-800 font-medium transition-colors group"
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 p-8">
            ...
            <div className="space-y-4" ref={imageRef}>
              <div className="relative bg-gray-50 rounded-xl overflow-hidden aspect-square flex items-center justify-center p-8">
                <img
                  src={currentView === 'front' ? design.images?.front : design.images?.back}
              ...
              {(design.images?.frontDesignArea || design.images?.backDesignArea) && (
                <div className="grid grid-cols-2 gap-3">
                  {design.images?.frontDesignArea && (
                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                      ...
                      />
                      <p className="text-xs text-gray-600 text-center mt-2">Front Design</p>
                    </div>
                  )}
                  {design.images?.backDesignArea && (
                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                      <img
                        ...
                        className="w-full h-24 object-contain"
                      />
                      <p className="text-xs text-gray-600 text-center mt-2">Back Design</p>
                    </div>
                  )}
                </div>
              )}
            ...
            <div className="flex flex-col" ref={detailsRef}>
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-gray-600 mb-6">
                  ...
                  <span className="text-lg">
                    Created by <span className="font-semibold text-gray-800">{design.createdBy?.fullName || 'Anonymous'}</span>
                  </span>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-6 mb-6">
                  ...
                  <p className="text-4xl font-bold text-purple-600">₹{design.sellPrice}</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-gray-800">{design.likesCount || 0}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                >
                  {design.isLiked ? <RiHeart3Fill size={24} /> : <RiHeart3Line size={24} />}
                  {design.isLiked ? 'Liked' : 'Like Design'}
                </button>

                <button className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 rounded-xl font-semibold text-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
