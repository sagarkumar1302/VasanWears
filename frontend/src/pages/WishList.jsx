...
import { RiDeleteBinLine, RiHeartLine, RiSearch2Line, RiShoppingBagLine, RiShoppingCartLine, RiStarSmileLine } from "@remixicon/react";
  ...
  return (
    <div className="md:py-10 pt-10">
      ...
      <div className="container mx-auto px-4 py-10">
        <h2 className="md:text-3xl  text-2xl font-semibold mb-8 text-center">My Wishlist ({PRODUCTS?.length})</h2>
