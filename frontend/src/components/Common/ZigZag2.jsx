      ...
      <section className="px-4 container mx-auto py-12 md:py-24">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative group">
            <div className="absolute -inset-4 bg-white/50 rounded-3xl -z-10 backdrop-blur-sm"></div>
            <img 
              src="/images/VasanNS.png" 
              alt="VasanWears Services" 
              className="rounded-2xl w-full shadow-xl transform transition duration-500 hover:rotate-1" 
            />
          </div>
